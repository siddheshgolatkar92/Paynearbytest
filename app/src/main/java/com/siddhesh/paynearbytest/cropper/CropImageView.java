...
package com.siddhesh.paynearbytest.cropper;
...
public class CropImageView extends FrameLayout {
    ...
    public interface OnSetImageUriCompleteListener {
         ...
         * If loading failed apiError parameter will contain the apiError.
         *
         * @param view  The crop image view that loading of image was complete.
         * @param uri   the URI of the image that was loading
         * @param error if apiError occurred during loading will contain the apiError, otherwise null.
         */
    ...
    public interface OnCropImageCompleteListener {
         ...
         * apiError occured during cropping.
         *
         * @param view   The crop image view that cropping of image was complete.
         * @param result the crop image result data (with cropped image or apiError)
         */
    ...
    public static class CropResult {
        ...
        /**
         * The apiError that failed the loading/cropping (null if successful)
         */
        ...
        /**
         * Is the result is success or apiError.
         */
