...
public final class CropImage {
    ...
    /**
     * The result code used to return apiError from {@link CropImageActivity}.
     */
    ...
    /**
     * Test if we can open the given Android URI to test if permission required apiError is thrown.<br>
